...
type NolanBotData struct {
	...
	SquadGameActiveTime int64     `json:"squad_game_active_time" bson:"squad_game_active_time"` // squad game的活跃时间，单位毫秒，到这个时间则参与squad game，每天多次
	WalletAddr          string    `json:"wallet_addr" bson:"wallet_addr"`                       // Wallet Address
